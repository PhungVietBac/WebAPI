...
@router.get("/{select}", response_model=list[BookingResponse], summary="Get booking by idPlace, date, status")
...
@router.get("/{idBooking}/users/", response_model=list[UserResponse])
...
@router.get("/{idBooking}/places/", response_model=PlaceResponse)
...
@router.put("/", response_model=BookingResponse)
...
@router.delete("/{id_booking}", response_model=dict[str, str])
